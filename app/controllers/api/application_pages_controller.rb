class Api::ApplicationPagesController < ApplicationController
  before_action :set_application_page, only: [:show, :destroy, :update]
  ...
  def create
    application_page = ApplicationPage.new(application_params)
  ...
  def set_application_page
    @application_page = ApplicationPage.find(params[:id])
  end

  def application_params
    params.require(:application_page).permit(
      :first_name, 
      :last_name, 
      :phone_number, 
      :email, 
